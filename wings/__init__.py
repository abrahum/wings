from typing import Dict, Iterable, Set, List, Type
...
import wings.builtin as builtin


def new_world_with_time() -> World:
    world = World()
    world.create_entity(builtin.Time())
    world.add_system(builtin.Timer(), priority=-1)
    return world
